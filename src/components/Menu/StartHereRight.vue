<template>
  <div class="StartHereRight">
    <div class="header-img">
      ...
      <span><img :src="herdData.logo" @error="herdData.logo=require('../../../assets/logo.png')"/></span>
    ...
    >
      <Form :model="dialog.form" :rules="rule" ref="form" labelWidth="95px">
        ...
        <FormItem label="原密码：" prop="userPassword">
          <Input type="password" v-model.trim="dialog.form.userPassword"/>
        </FormItem>
        <FormItem label="新密码：" prop="userNewPassword">
          <Input type="password" v-model.trim="dialog.form.userNewPassword"/>
        </FormItem>
        <FormItem label="确认密码：" prop="surePwd">
          <Input type="password" v-model.trim="dialog.form.surePwd"/>
        </FormItem>
      </Form>
