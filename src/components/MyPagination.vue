<template>
  <Pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="page" :page-sizes="pageSizes" :page-size="pageSize" @next-click='handleCurrentChange' layout="total, sizes, prev, pager, next, jumper" :total="total">
  </Pagination>
</template>
<script>
